...
function Set(color){
  window.open('configurar.php?acao=form&id=<? echo $id?>&nivel=<? echo $nivel?>&novacortexto=' + color, 'pai');
  window.close();
}
</script>
<? }?>
...
function Set(color){
  window.open('configurar.php?acao=form&id=<? echo $id?>&nivel=<? echo $nivel?>&novacoronmouse=' + color, 'pai');
  window.close();
}
</script>
<? }?>
...
function Set(color){
  window.open('configurar.php?acao=form&id=<? echo $id?>&nivel=<? echo $nivel?>&novacorcelula1=' + color, 'pai');
  window.close();
}
</script>
<? }?>
...
function Set(color){
  window.open('configurar.php?acao=form&id=<? echo $id?>&nivel=<? echo $nivel?>&novacorcelula2=' + color, 'pai');
  window.close();
}
</script>
<? }?>

<? if($campo == corfundosite){?>
<script language="javascript">
function View(color) {                  // preview color
  document.all.ColorPreview.style.backgroundColor = '#' + color;
  document.all.ColorHex.value = '#' + color;
...
function Set(color){
  window.open('configurar.php?acao=form&id=<? echo $id?>&nivel=<? echo $nivel?>&novacorfundosite=' + color, 'pai');
  window.close();
}
</script>
<? }?>
