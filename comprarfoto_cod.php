...
<table width=280 border=0 align=center cellpadding=0 cellspacing=0>
 <tr>
   <TD><font color=$cortexto size=$tfonte face=$fonte>Olá <strong>$nomepara</strong>,
<BR>
     <BR>
     <strong><a href=\"mailto:$email\">$nome</a></strong> quer comprar esta foto! <br>
  $email
  <br>
  <br>
  $telefone
...
// E-mail no qual vai ser enviado o pedido de foto (se for mais de um separar com virgula)
$destino = "seuemail@seusite.com.br";
